...
class AssetsSearchByCostPerVolumeTest {
    ...
    private lateinit var assetStrategy: AssetsSearchByCostPerVolume
    ...
    fun setup() {
        ...
        assetStrategy = AssetsSearchByCostPerVolume(assetSelectionService)
    }
    ...
    fun testModeSupportedIsEqual() {
        assertTrue(assetStrategy.modeSupported(CalculationMode.RATIO))
    }

    @Test
    fun testModeSupportedIsDIfferent() {
        assertFalse(assetStrategy.modeSupported(CalculationMode.VOLUME))
    }
}